							...
							<fieldset>
								<div class="container">
									...
									<div class="row">
										...
										<div class="col-lg-4">
											<button class="btn btn-warning"><span class="glyphicon glyphicon-save"></span> Guardar</button>
										</div>
									</div>
									<br />
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="alert alert-danger">
												<strong>¡Cuidado!</strong> Cambiar el año contable significa cerrar el período contable, si lo cambia y aún no ha cerrado período habrá inconsistencia con la información. Cambie el año contable solamente cuando haya cerrado el período contable.
											</div>
										</div>
									</div>
