        						...
        						<div class="container">
        							...
        							<div class="row">
        								<div class="col-lg-12">
        									...
        									<textarea name="descripcion_grupo_txa" id="descripcion_grupo" class="form-control" placeholder="Escriba una descripción para el grupo a crear."></textarea>
        								</div>
        							</div>
        							<br>
        							<div class="row">
        						...
        						<div class="container">
        							...
        							<div class="row">
        								<div class="col-lg-12">
        									...
        									<textarea name="descripcion_subgrupo_txa" id="descripcion_subgrupo" class="form-control" placeholder="Escriba una descripción para el subgrupo"></textarea>
        								</div>
        							</div>
        							<br>
        							<div class="row">
        						...
        						<div class="container">
        							<div class="row">
        								<div class="col-lg-4">
        									...
        									<select name="grupos_slc" id="subgrupos" class="form-control">
        							...
        							<div class="row">
        								<div class="col-lg-12">
        									...
        									<textarea name="descripcion_cuenta_txa" id="descripcion_cuenta" class="form-control" placeholder="Escriba una descripción para la cuenta a crear."></textarea>
        								</div>
        							</div>
        							<br>
        							<div class="row">
